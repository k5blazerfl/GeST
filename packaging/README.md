...
- **`gest-0.36.0`** — the latest released version (urwid; depends only on
  `::gentoo` packages), from the `v0.36.0` tag tarball (`~amd64`). Recommended —
  Software Management filter power + rich detail pane + Actions menu.
