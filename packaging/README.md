...
- **`gest-0.29.0`** — the latest released version (urwid frontend; depends
  only on `::gentoo` packages), from the `v0.29.0` tag tarball (`~amd64`).
  Recommended. (`gest-0.20.0`/`0.21.0` — Textual-based — remain available.)
