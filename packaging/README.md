...
- **`gest-0.31.2`** — the latest released version (urwid; depends only on
  `::gentoo` packages), from the `v0.31.2` tag tarball (`~amd64`). Recommended —
  completes the polkit fix for newer PyGObject (Python 3.14).
