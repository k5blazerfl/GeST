...
- **`gest-0.38.0`** — the latest released version (urwid; depends only on
  `::gentoo` packages), from the `v0.38.0` tag tarball (`~amd64`). Recommended —
  Software gains a Provides(file) view + Description search field.
