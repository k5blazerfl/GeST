...
- **`gest-0.36.1`** — the latest released version (urwid; depends only on
  `::gentoo` packages), from the `v0.36.1` tag tarball (`~amd64`). Recommended —
  Control Center chrome tuned to YaST.
