...
- **`gest-0.32.1`** — the latest released version (urwid; depends only on
  `::gentoo` packages), from the `v0.32.1` tag tarball (`~amd64`). Recommended —
  adds the Software Management dropdown menu bar.
