...
- **`gest-0.37.0`** — the latest released version (urwid; depends only on
  `::gentoo` packages), from the `v0.37.0` tag tarball (`~amd64`). Recommended —
  Software detail pane gains Size + Required-by.
