...
- **`gest-0.31.4`** — the latest released version (urwid; depends only on
  `::gentoo` packages), from the `v0.31.4` tag tarball (`~amd64`). Recommended —
  strips ANSI colour codes from command output.
