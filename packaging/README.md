...
- **`gest-0.41.0`** — the latest released version (urwid; depends only on
  `::gentoo` packages), from the `v0.41.0` tag tarball (`~amd64`). Recommended —
  adds the System Logs module.
