...
- **`gest-0.31.3`** — the latest released version (urwid; depends only on
  `::gentoo` packages), from the `v0.31.3` tag tarball (`~amd64`). Recommended —
  fixes garbled emerge output (UTF-8 locale for the backend).
