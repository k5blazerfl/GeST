...
- **`gest-0.32.0`** — the latest released version (urwid; depends only on
  `::gentoo` packages), from the `v0.32.0` tag tarball (`~amd64`). Recommended —
  adds the make.conf editor module.
