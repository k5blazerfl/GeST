...
- **`gest-0.31.5`** — the latest released version (urwid; depends only on
  `::gentoo` packages), from the `v0.31.5` tag tarball (`~amd64`). Recommended —
  renders ANSI colours in streamed output.
