...
Nothing is written until **F10 (Accept)**, which commits everything at once:
...
class WorldScreen(Screen):
    ...
    def __init__(self, app: App) -> None:
        ...
        self._actions = focusable_actions([
            ("Cancel", app.pop), ("Accept", self._apply)])
        self._pile = NavPile([
        ...
        super().__init__(
            ...
            help_text=(
                ...
                "Edits are staged and applied together with F10 (Accept):\n"
    ...
    def _footer_context(self):
        ...
        apply = [("F10", "Accept")] if self._has_pending() else []
    ...
    def _refresh_count(self) -> None:
        ...
        if summary:
            parts.append(("ok", f"   ·   {summary} · F10 Accept"))
    ...
    def _apply(self) -> None:
        ...
        modal = Modal(self.app, "Apply staged changes?", body,
                      [("Accept", self._run_apply), ("Cancel", self.app.pop)])
